    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ URL::to('/Unidad') }}"><?php $usuario = User::find(Auth::user()->id)->UserUnidad()->first(); $Unidad=Unidad::find($usuario->id_unidad);?>{{$Unidad->tipo}} {{$Unidad->nombre}}</a>
            </div>
            <!-- /.navbar-header -->
                         ...
                         <li>
                            <a href=""><i class="fa fa-stethoscope fa-fw"></i>Equipos<span class="fa arrow"></span></a>
                             <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ URL::to('Unidad/Equipos/Show') }}">Ver Todos</a>
                                </li>
                                 <li>
                                    <a href="{{ URL::to('Unidad/Equipos/Add') }}">Agregar</a>
                                </li>
                             </ul>
                        </li> 
                    </ul>
